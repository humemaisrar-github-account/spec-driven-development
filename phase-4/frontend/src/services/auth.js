  ...
  async checkSession() {
    try {
      ...
      const apiUrl = typeof window !== 'undefined'
        ...
        : `http://todo-app-todoflow-chatbot-backend:8000/api/auth/get-session`;
  ...
  async register(userData) {
    try {
      ...
      try {
        ...
        const apiUrl = typeof window !== 'undefined'
          ? '/api/auth/sign-up'
          : `http://todo-app-todoflow-chatbot-backend:8000/api/auth/sign-up`;
        ...
        const backendResponse = await fetch(`http://todo-app-todoflow-chatbot-backend:8000/api/auth/register`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
            ...
            if (sessionData?.session?.user) {
              ...
              try {
                ...
                while (retryCount < 3 && !tokenSuccess) {
                  try {
                    const backendTokenResponse = await fetch(`http://todo-app-todoflow-chatbot-backend:8000/api/auth/token`, {
                      method: 'POST',
                      headers: {
                        'Content-Type': 'application/json',
                      },
  ...
  async login(credentials) {
    try {
      ...
      try {
        ...
        const apiUrl = typeof window !== 'undefined'
          ? '/api/auth/sign-in'
          : `http://todo-app-todoflow-chatbot-backend:8000/api/auth/sign-in`;
        ...
        const backendResponse = await fetch(`http://todo-app-todoflow-chatbot-backend:8000/api/auth/login`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
      ...
      try {
        ...
        while (retryCount < 3 && !tokenSuccess) {
          try {
            const backendResponse = await fetch(`http://todo-app-todoflow-chatbot-backend:8000/api/auth/token`, {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
              },
  ...
  async logout() {
    try {
      ...
      try {
        ...
        const apiUrl = typeof window !== 'undefined'
          ? '/api/auth/sign-out'
          : `http://todo-app-todoflow-chatbot-backend:8000/api/auth/sign-out`;
      ...
      try {
        await fetch(`http://todo-app-todoflow-chatbot-backend:8000/api/auth/logout`, {
          method: 'POST',
        });
      } catch (err) {
